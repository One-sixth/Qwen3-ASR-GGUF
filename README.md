...
### 命令行
    ...
    Usage: transcribe.exe [OPTIONS] FILES...
    Try 'transcribe.exe --help' for help.
    ╭─ Error ──────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
    │ Missing argument 'FILES...'.                                                                                         │
    ╰──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
    (normal) PS D:\Qwen3-ASR-Transcribe> .\transcribe.exe --help
    ...
    ╰──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
    ╭─ 模型配置 ───────────────────────────────────────────────────────────────────────────────────────────────────────────╮
    │ --model-dir  -m                 TEXT     模型权重根目录                                                              │
    │                                          [default:                                                                   │
    │                                          D:\Qwen3-ASR-Transcribe\model]         │
